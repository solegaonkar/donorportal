...
<li>
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <table id="donor" class="table table-striped table-bordered wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                      <thead>
                         <tr>
                          <th width="3%">Sr.No.</th>
                          <th>Donor ID</th>
					  ...
					  <?php
						...
						$donor = new VSM_Digi();
						$donorlist=$donor->report_donorlist();
					   ...
					   ?>
							<tr>
							  <td></td>
							  <td><?php echo "D".$row["did"]; ?></td>
							  <td style="overflow:hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo ucfirst(trim($row["fname"]." ".$row["mname"]." ".$row["lname"])); ?></td>
							  <td style="overflow:hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo $row["address1"]; ?></td>
							  <td style="overflow:hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo $row["address2"]; ?></td>
							  <td style="overflow:hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo $row["address3"]; ?></td>
							  <td><?php echo $row["isvip"]; ?></td>
							  ...
							  <td><?php echo ucfirst($row["iscompany"]); ?></td>
							  <td style="overflow:hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo $row["donorcat"]; ?></td>
        ...
        <script src="assets/js/app.js"></script>
        <script src="assets/js/reports_donorlist.js">        
</script>
