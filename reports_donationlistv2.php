...
<head>
        <meta charset="utf-8" />
        <title>VSM Thane | Donations Report</title>
...
<li>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title-box">
                                    <h4 class="font-size-18">Donation Report version 2.0</h4>
                                    <ol class="breadcrumb mb-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Reports</a></li>
                                        <!-- <li class="breadcrumb-item"><a href="javascript: void(0);">Tables</a></li> -->
                                        <li class="breadcrumb-item active">Donation Report version 2.0</li>
                                    </ol>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <table id="donation" class="table table-striped table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                      <thead>
						<tr>
						  <th width="3%">Sr.No.</th>
						  <th>Donor ID</th>
						...
						<tbody>
						  <?php
							...
							$donationlist = new VSM_Digi();

							$list=$donationlist->report_donationlist_v2();
						  ...
						  ?>
							<tr>
								...
								<td style="overflow:hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo $row["address"]; ?></td>
								<td style="overflow:hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo $row["mobile"]; ?></td>
								<td style="overflow:hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo $row["email"]; ?></td>
								<td style="overflow:hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo $row["pancard"]; ?></td>
								<td style="overflow:hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo $row["isvip"]; ?></td>
								<td style="overflow:hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo $row["iscompany"]; ?></td>
								...
								<td style="overflow:hidden; white-space: nowrap; text-overflow: ellipsis;"><?php echo $row["remarks"]; ?></td>
							</tr>
						  <?php
						    }
						  ?>
        ...
        <script src="assets/js/app.js"></script>
        <script src="assets/js/reports_donationlist.js"></script>
